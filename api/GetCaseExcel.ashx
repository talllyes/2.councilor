...
public class intersectionDetailExcel : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (type.Equals("getExcel"))
        {
            ...
            if (excelType.Equals("CaseListAll"))
            {
            ...
            else if (excelType.Equals("My"))
            {
                ...
                foreach (var temp in resultTmp)
                {
                    ...
                    if (temp.CaseOfficerID != user.UserLoginID)
                    {
                        flag = false;
                    }
                    if (flag)
            ...
            HSSFSheet u_sheet = (HSSFSheet)workbook.CreateSheet("表一");
            SetSheet(u_sheet);
            int i = 0;
